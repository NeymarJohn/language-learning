...
const SelectLevel = () => {
  ...
  const goNext = () => {
    NavigationService.navigate(Routes.COMPLETE_INTRO);
  };
  ...
  return (
    <LoadingActionContainer fixed>
      ...
      <View
        ...
        <View style={{flex: 1}}>
          <Text style={{fontSize: 15}} text={t('level_quiz1')} />
          <Text style={{fontSize: 15}} text={t('level_quiz2')} />
        </View>
      </View>
      <ScrollView>
        <Container
          ...
          <View
            ...
            {levelList.map(item => {
              return (
                <TouchableOpacity
                  key={item.img}
                  onPress={() => selectReason(item.item)}>
                  <View
                    style={{
                      flexDirection: 'row',
                      alignContent: 'center',
                      ...
                      borderColor:
                        active == item.item
                          ...
                          : theme.colors.accent,
                      borderWidth: active == item.item ? 4 : 1,
                      margin: 3,
                    }}>
                    <Image
